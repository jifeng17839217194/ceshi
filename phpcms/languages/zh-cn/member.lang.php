...
$LANG['no_phpcms_account'] = '您还没有注册用户？';
$LANG['immediately'] = '立即';
...
$LANG['userid_banned_by_administrator'] = '您的用户组为禁止访问';
...
$LANG['buy_point'] = '购买积分';
$LANG['point'] = '积分点数';
$LANG['point_notice'] = '，积分点数将影响用户组';
$LANG['changegroup_notice'] = '非vip用户组与积分绑定，如只修改用户组请设置该用户为vip';
$LANG['lock'] = '锁定';
...
$LANG['forget_password_notice'] = '提交后请在一小时内登录邮箱重置用户密码。';
$LANG['or'] = '或';
$LANG['remember'] = '记住';
$LANG['vip'] = 'vip用户';
$LANG['isvip'] = '是否为vip用户';
...
$LANG['allow_register'] = '允许新用户注册';
$LANG['register_model'] = '注册选择模型';
$LANG['need_more_memberinfo'] = '请填写用户详细信息';
$LANG['register_email_auth'] = '新用户注册需要邮件验证';
$LANG['enablemailcheck_notice'] = '需填写邮箱配置，开启后用户注册审核功能无效';
$LANG['allow_memberlist'] = '允许前台浏览用户列表';
$LANG['register_verify'] = '新用户注册需要管理员审核';
$LANG['administrator'] = '管理员';
$LANG['member_verifycode'] = '用户注册启用验证码功能';
$LANG['click_change_validate'] = '点击更换验证码';
$LANG['upgrade_method'] = '用户升级付费方式';
$LANG['defualtpoint'] = '新用户默认点数';
$LANG['defualtamount'] = '新用户注册默认赠送资金';
$LANG['register_protocol'] = '用户注册协议';
$LANG['show_register_protocol'] = '是否显示注册协议';
$LANG['show_app_point'] = '是否启用应用间积分兑换';
$LANG['rmb_point_rate'] = '1元人民币购买积分数量';

$LANG['member_totalnum'] = '用户总数';
$LANG['register'] = '注册';
$LANG['register_notice'] = '更改用户模型会刷新页面，请首先选择用户模型。';
$LANG['success'] = '成功';
$LANG['agree'] = '同意';
$LANG['notice'] = '注意';
$LANG['member_verify_totalnum'] = '待审核用户数';
$LANG['nolimit'] = '无限制';
$LANG['member_search'] = '搜索用户';
$LANG['member_vip_totalnum'] = 'vip用户数';
$LANG['member_research'] = '重新搜索';
$LANG['normal'] = '正常';
$LANG['member_statistics'] = '用户统计';
$LANG['member_todaynum'] = '今日新增';
$LANG['normal'] = '正常';
$LANG['please_click'] = '请点击';
$LANG['reg_verify_email'] = '注册用户验证邮件';
$LANG['invalid_appid'] = '应用未通过盛大验证，请联系管理员';

$LANG['model_name'] = '模型名称';
$LANG['all_site'] = '所有站点';
$LANG['belong_to_site'] = '是否为公共模型';
$LANG['site_have_no_model'] = '站点无用户模型';
$LANG['model_import'] = '导入模型';
$LANG['member_model_add'] = '添加用户模型';
$LANG['member_model'] = '用户模型';
...
$LANG['move_member_model_alert'] = '移动模型用户，将会把原有模型里的用户信息删除，不能修复。';
$LANG['move_member_model_index_alert'] = '1、请谨慎删除模型，当模型里存在用户时请使用“移动”功能将该模型里的用户移动到其他用户模型中。<br />2、移动模型用户，将会把原有模型里的用户信息删除，将不能修复。 ';
...
$LANG['deny_set_field_group'] = '禁止设置字段值的用户组';
...
$LANG['deny_upgrade'] = '您所在的用户组禁止自主升级';
