...
//index
$LANG['admin_site_title'] = '蜂博士 - 后台管理中心';
...
$LANG['domain_name_format'] = '域名可为空，格式应该为http://www.****.cn/';
$LANG['domain_end_string'] = '格式应该为http://www.****.cn/，请以‘/’结束';
...
$LANG['group_private'] = '用户组权限';
$LANG['group_name'] = '用户组名称';
$LANG['allow_vistor'] = '允许访问';
$LANG['allow_contribute'] = '允许投稿';
$LANG['contribute_add_point'] = '投稿奖励';
$LANG['contribute_add_point_tips'] = '点 （用户在此栏目发表信息时可以得到的点数，为负数时减积分）';
$LANG['default_readpoint'] = '默认收取';
$LANG['readpoint'] = '点';
$LANG['readpoint_tips'] = '（用户在此栏目下查看信息时，该信息默认的收费），当这里设置为0时，发布页设置了，可只对设置的文章收费，<font color="red">生成静态时收费无效</font>';
$LANG['money'] = '元';
...
$LANG['site_domain_ex'] = '请填写域名，格式为：http://www.****.cn/';
$LANG['site_domain_ex2'] = '格式应该为http://www.****.cn/，请以‘/’结束';
...
$LANG['workflow'] = '工作流';
$LANG['dbsource'] = '数据源';
$LANG['member_group'] = '用户列表';
$LANG['membermodel'] = '用户模型';
$LANG['member_model_field'] = '用户模型字段';
