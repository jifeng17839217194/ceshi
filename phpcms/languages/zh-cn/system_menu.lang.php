...
*/
$LANG['member_manage'] = '管理用户';
$LANG['member_add'] = '添加用户';
$LANG['member_edit'] = '编辑用户';
$LANG['member_verify'] = '审核专家申请';
$LANG['member_group_manage'] = '用户组管理';
$LANG['member_model'] = '用户模型管理';
$LANG['member_group_add'] = '添加用户组';
$LANG['member_model_add'] = '添加用户模型';
$LANG['member_model_import'] = '导入用户模型';
$LANG['members'] = '用户';
$LANG['member_group_manage'] = '管理用户组';
$LANG['member_model_manage'] = '管理用户模型';
$LANG['manage_member'] = '用户管理';
$LANG['manage_member_group'] = '用户组管理';
$LANG['manage_member_model'] = '用户模型管理';
$LANG['menu_add'] = '添加菜单';
$LANG['site_edit'] = '编辑站点';
$LANG['site_del'] = '删除站点';
$LANG['add_site'] = '添加站点';
...
$LANG['member_lock'] = '锁定用户';
$LANG['member_unlock'] = '解锁用户';
$LANG['member_move'] = '移动用户';
$LANG['member_delete'] = '删除用户';
$LANG['memebr_verify'] = '审核专家申请';
$LANG['template_file_list'] = '模板文件列表';
$LANG['template_file_edit'] = '模板文件编辑';
$LANG['member_setting'] = '用户模块配置';
...
$LANG['member_model_delete'] = '删除用户模型';
$LANG['member_model_edit'] = '修改用户模型';
$LANG['link'] = '友情链接';
$LANG['comment'] = '评论';
$LANG['workflow'] = '工作流';
...
$LANG['member_modelfield_add'] = '添加用户模型字段';
$LANG['member_modelfield_edit'] = '编辑用户模型字段';
$LANG['member_modelfield_delete'] = '删除用户模型字段';
$LANG['member_modelfield_manage'] = '用户模型字段管理';
...
$LANG['member_edit'] = '编辑用户';
$LANG['member_group_edit'] = '编辑用户组';
$LANG['member_group_delete'] = '删除用户组';
$LANG['member_model_export'] = '导出用户模型';
$LANG['member_model_sort'] = '用户模型排序';
$LANG['member_model_move'] = '移动模型用户';
...
$LANG['linkage'] = '课程设置';
$LANG['videolinkage'] = '课程设置';
$LANG['linkageage'] = '课程栏目';
$LANG['poster'] = '广告设置';
$LANG['member_wenwenmodule'] = '用户擅长选项';
$LANG['wenwen'] = '问问';
$LANG['wenwen'] = '问题管理';
$LANG['managepost'] = '回复管理';
?>