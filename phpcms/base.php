...
pc_base::load_sys_class("register_error_handler","", 0);
register_error_handler::register();
...
//API路径
define('API_PATH',pc_base::load_config('system','api_path'));
//后台程序路径
define('ADMIN_PATH',pc_base::load_config('system','admin_path'));
//动态程序路径
define('PLOYV_ID',pc_base::load_config('system','ployv_id'));
define('PLOYV_KEY',pc_base::load_config('system','ployv_secretkey'));
//应用静态文件路径
