...
class form {
	...
	public static function editor($textareaid = 'content', $toolbar = 'basic', $module = '', $catid = '', $color = '', $allowupload = 0, $allowbrowser = 1,$alowuploadexts = '',$height = 200,$disabled_page = 0, $allowuploadnum = '10') {
		...
		if($toolbar == 'basic') {
			...
			$toolbar .= "'emotion','Bold','Italic','simpleupload', 'insertimage','attachment' ]";
		} elseif($toolbar == 'full') {
			if(defined('IN_ADMIN')) {
				$toolbar = "['Source',";
			} else {
		...
		$str .= "var editor = new baidu.editor.ui.Editor({".join(",",$opt)."});editor.render('$textareaid');\n";
		$str .= '</script>';
