...
class tree {
	...
	*/
	 ...
	 * @return array
	 */
	public function get_tree_array($myId, $maxLevel = 0, $level = 1)
	{
	    $returnArray = [];
	    
	    //一级数组
	    $children = $this->get_child($myId);
	    ...
	    if (is_array($children)) {
	        foreach ($children as $child) {
	            ...
	            if ($maxLevel === 0 || ($maxLevel !== 0 && $maxLevel > $level)) {
	                ...
	                $mLevel                                = $level + 1;
	                $returnArray[$child['id']]["children"] = $this->get_tree_array($child['id'], $maxLevel, $mLevel);
	            }
