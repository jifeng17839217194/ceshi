...
<div class="showMsg" style="text-align:center">
	...
	<?php if ($dialog):?><script style="text/javascript">setTimeout(function(){parent.location.reload();window.top.art.dialog({id:"<?php echo $dialog?>"}).close();},1000);</script><?php endif;?>
        </div>
</div>
