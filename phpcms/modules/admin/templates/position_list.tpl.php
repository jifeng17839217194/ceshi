...
<div class="subnav">
    ...
    <a class="add fb" href="javascript:window.top.art.dialog({id:'add',iframe:'?m=admin&c=position&a=add', title:'添加推荐位', width:'500', height:'360', lock:true}, function(){var d = window.top.art.dialog({id:'add'}).data.iframe;var form = d.document.getElementById('dosubmit');form.click();return false;}, function(){window.top.art.dialog({id:'add'}).close()});void(0);"><em>添加推荐位</em></a>　    <a href='javascript:;' class="on"><em>推荐位管理</em></a>    </div>
</div>
